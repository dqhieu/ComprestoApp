      ...
      Section {
        ...
        Toggle(isOn: $confettiEnabled) {
          VStack(alignment: .leading) {
            ...
            Text("Requires [Raycast](https://www.raycast.com/) to be installed. [Read the docs](https://compresto.app/docs/customization/conffeti) or [test confetti](raycast://confetti)")
...
//          }
//
//          IconView(iconName: "Original",
//                   displayName: "Original",
//                   twitterHandle: nil,
//                   selectedIconName: selectedAppIconName) {
//            if let iconImage = NSImage(named: "Original") {
//              changeIcon(iconImage: iconImage, iconName: "Original")
//            }
//          }
//
